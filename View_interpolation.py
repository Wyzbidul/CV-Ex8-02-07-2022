...
def main(imgLpath, imgRpath, nb_matches, i, not_rectified):
    ...
    if not_rectified:
        ...
        cv2.imwrite("./results/keypoints.jpg", res)
        #cv2.imshow("keypoints", res)
        cv2.drawMatches(left, kpts1, right, kpts2, good_matches, res)
        cv2.imwrite("./results/keypoints_without_RANSAC.jpg", res)
        #cv2.waitKey(0)
        ...
        dst1 = left
        dst2 = right
    cv2.imwrite("./results/rectify1.png", dst1)
    cv2.imwrite("./results/rectify2.png", dst2)
    ...
    cv2.imwrite("./results/disparity.png", disparity_img)
    print(disparity)
    ...
    if not_rectified:
        ...
        cv2.imwrite("./results/derectified.png", de_rect)
